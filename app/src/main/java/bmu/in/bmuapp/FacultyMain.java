 ...
 */
        ...
        mNavigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                {
                    Intent i = new Intent(FacultyMain.this, faculty_courses.class);
                    startActivity(i);
                }
                ...
                {
                    Intent i = new Intent(FacultyMain.this, NearestFaci.class);
                    startActivity(i);
                }

                if(menuItem.getItemId()== R.id.nav_item_draft)
                {
                    Intent i = new Intent(FacultyMain.this, fulltimetable.class);
                    startActivity(i);
                }
